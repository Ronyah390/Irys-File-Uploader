...
function App() {
  ...
  useEffect(() => {
    ...
    const memesCollectionRef = collection(db, `artifacts/${appId}/public/data/memes`);
    const q = query(memesCollectionRef, orderBy("createdAt", "desc"));
